...
def terminos(request):
    ...
    inf3 = Sis_Informacion.objects.filter(inf_tipo=4).first()
    ...
    terms = Sis_Informaciondetalle.objects.filter(inf_id=inf3_id) if inf3_id else Sis_Informaciondetalle.objects.none()
    context = {'segment': 'contact',
               'redes': redes,
               'contact': contact,
               'terms': terms
               }
    html_template = loader.get_template('home/terminos.html')
